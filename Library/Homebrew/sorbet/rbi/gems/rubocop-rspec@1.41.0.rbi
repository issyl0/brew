...
RuboCop::Cop::RSpec::Cop::DEFAULT_PATTERN_RE = T.let(T.unsafe(nil), Regexp)
...
RuboCop::Cop::RSpec::Focus::FOCUSABLE_SELECTORS = T.let(T.unsafe(nil), String)
...
RuboCop::Cop::RSpec::HookArgument::HOOKS = T.let(T.unsafe(nil), String)
